...
IPAddress PGIP(192,168,43,206);        // your PostgreSQL server IP

const char ssid[] = "lenovo";      //  your network SSID (name)
const char pass[] = "12345678";      // your network password

const char user[] = "postgres";       // your database user
const char password[] = "123456";   // your database password
const char dbname[] = "monitoring_listrik";         // your database name
...
byte ip[] = {192, 168, 43, 177};                    // your IP address
#endif
